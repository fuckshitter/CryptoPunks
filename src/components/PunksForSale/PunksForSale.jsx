...
//    this.props.history.push("#/mint");
  ...
  render() {
    ...
    for (const [index, value] of elements.entries()) {
      ...
      items.push(<div {...{ ['price']: value }} class="card col-md-3" ><img src={newImageUrl} /><div class="card-body"> <h5 class="card-title">NO {index}</h5><p class="card-text"> PRICE {value} BNB</p><Link to={newLinkUrl} className="nav-link" >BUY</Link></div></div>)
