...
class AllCryptoBoys extends Component {
  ...
  render() {
    ...
    for (const [index, value] of elements.entries()) {
      ...
      items.push(<div class="card col-md-3" ><img src={newImageUrl} /><div class="card-body"> <h5 class="card-title">PUNK NO {index}</h5><p class="card-text"> PUNK OWNER {value}</p><Link to="/marketplace" className="nav-link">Select</Link></div></div>)
    }
